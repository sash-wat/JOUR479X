...
```{r}
clubs <- read_csv("./TransferMarkt Data/clubs.csv")
players <- read_csv("./TransferMarkt Data/players.csv")
player_valuations<- read_csv("./TransferMarkt Data/player_valuations.csv")
games <- read_csv("./TransferMarkt Data/games.csv")
game_events <- read_csv("./TransferMarkt Data/game_events.csv")
comps <- read_csv("./TransferMarkt Data/competitions.csv")
club_games <- read_csv("./TransferMarkt Data/club_games.csv")
appearances <- read_csv("./TransferMarkt Data/appearances.csv")
...
```{r}
test <- read_csv("https://drive.google.com/file/d/1u4Q_TYO_z8XYU_J5Si4-A0UwIef1ndy8/view?usp=drive_link")
```
